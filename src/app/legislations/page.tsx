    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="h-[calc(100vh-120px)] flex items-center justify-center">
        <div className="text-center p-8 max-w-lg">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">Legislation Quick Reference</h2>
          <p className="text-gray-400 mb-8 text-lg">
            Access our comprehensive legislation database with detailed legal references, 
            offence definitions, and punishment guidelines.
          </p>
          <a 
            href="https://legislations.thefirm.club/" 
            target="_blank" 
