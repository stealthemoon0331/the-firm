    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="h-[calc(100vh-120px)] flex items-center justify-center">
        <div className="text-center p-8 max-w-lg">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">Premium Store</h2>
          <p className="text-gray-400 mb-8 text-lg">
            Access our official Tebex store for premium business opportunities, exclusive perks, 
            and subscription-based enterprises. Purchase business subscriptions, unlock exclusive 
            add-ons, and support the ongoing development of The Firm.
          </p>
          <a 
            href="https://buy.thefirm.club/" 
            target="_blank" 
